...
public class ObjectDetectionView extends VBox {
    ...
    //-----------------------
    public ObjectDetectionView(QuPathGUI qupath, EnvironmentModel envModel) {

        ObjectDetectionModel model = new ObjectDetectionModel();
        ObjectDetectionController controller = new ObjectDetectionController(qupath, envModel, model, this);
