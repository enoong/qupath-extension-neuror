...
classNames = [%s] // names of classes of ROI (in this case two classes, excluding the background class)
...
// Get path of image
def import_filename = GeneralTools.stripExtension(getProjectEntry().getImageName())
